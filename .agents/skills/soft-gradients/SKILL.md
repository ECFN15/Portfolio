...
You are designing in the Soft Gradients style. The output must feel ambient, smooth, calm, luminous, soft, modern. Do not merely apply a color theme; build a coherent visual system across layout, typography, color, component geometry, imagery, motion, and interaction states.

Use this skill when the user asks for soft gradient websites, AI tools, wellness, calm SaaS, atmospheric brand pages, polished modern interfaces.
...
- Dia Browser - Soft Gradients Source Notes: 
- Sprig - Soft Gradients Source Notes: 
- Superhuman - Soft Gradients Source Notes: 
- Retool - Soft Gradients Source Notes: 
...
| --- | --- | --- |
| Base44 - Soft Gradients Source Notes | Visual system reference | light expression, layout rhythm, component behavior |
| Dia Browser - Soft Gradients Source Notes | Visual system reference | light expression, layout rhythm, component behavior |
| Sprig - Soft Gradients Source Notes | Visual system reference | light expression, layout rhythm, component behavior |
| Superhuman - Soft Gradients Source Notes | Visual system reference | mixed expression, layout rhythm, component behavior |
| Retool - Soft Gradients Source Notes | Visual system reference | dark expression, layout rhythm, component behavior |
...
`This interface is a Soft Gradients system for [audience] that feels ambient, smooth, calm, luminous, soft, modern and uses [layout move], [type move], [color move], and [component move] to make [primary action] obvious.`
...
2. Chosen Soft Gradients sub-direction.
...
- The first viewport clearly expresses Soft Gradients.
...
Design a Soft Gradients interface that feels ambient, smooth, calm, luminous, soft, modern. Build a coherent system, not a skin: define layout, type, color, component geometry, imagery, motion, states, and responsive behavior. Use the reference database only to extract transferable rules, not to clone a source.

### Website Prompt

Create a complete Soft Gradients website with navigation, a first viewport that states the product clearly, product or brand evidence, reusable sections, a clear conversion path, and a designed footer. The style must be visible in the first viewport and must remain usable on mobile.

### App Prompt

Create a Soft Gradients app interface for repeated use. Prioritize the main workflow, control placement, information density, readable state design, and keyboard-accessible interactions. Preserve the style through surfaces, typography, spacing, and component behavior rather than decorative effects.

### Redesign Prompt

Redesign the existing interface in a Soft Gradients direction. Preserve functionality and information architecture unless the user asks otherwise. Remove generic AI design patterns, assign tokens, improve hierarchy, define states, and make the first screen feel specific.

### Critique Prompt

Audit this design against Soft Gradients. Identify generic defaults, weak hierarchy, misuse of color, bad typography, missing states, poor mobile behavior, and places where the style is decorative instead of structural.
