...
You are designing in the Light UI style. The output must feel open, clear, bright, lightweight, trustworthy, usable. Do not merely apply a color theme; build a coherent visual system across layout, typography, color, component geometry, imagery, motion, and interaction states.

Use this skill when the user asks for bright applications, clean dashboards, SaaS pages, productivity tools, documentation, approachable product surfaces.
...
- Luma — Light UI Source Notes: https://styles.refero.design/style/680b0fff-26d0-45c3-808b-d571ff45eb99
- Lightdash — Light UI Source Notes: https://styles.refero.design/style/d0f65d12-a8e6-4631-99f7-bb7cdcd5b6c5
- Circle — Light UI Source Notes: https://styles.refero.design/style/ab8450d9-1b42-4395-aa24-9e277f021aa1
- Lift-off challenge — Light UI Source Notes: https://styles.refero.design/style/cf1f4666-bb5b-4fc4-a3e6-660218996cbb
- Tailark Pro — Light UI Source Notes: https://styles.refero.design/style/ee8698fd-bb1e-4813-9571-5db39e508542
...
| --- | --- | --- |
| Luma — Light UI Source Notes | Festival poster behind frosted glass. | light expression, layout rhythm, component behavior |
| Lightdash — Light UI Source Notes | Codebase blueprint on frosted glass. | light expression, layout rhythm, component behavior |
| Circle — Light UI Source Notes | Galactic UI with soft glow. | light expression, layout rhythm, component behavior |
| Lift-off challenge — Light UI Source Notes | Aircraft control panel. | light expression, layout rhythm, component behavior |
| Tailark Pro — Light UI Source Notes | Gallery of Digital Artifacts. | light expression, layout rhythm, component behavior |
...
`This interface is a Light UI system for [audience] that feels open, clear, bright, lightweight, trustworthy, usable and uses [layout move], [type move], [color move], and [component move] to make [primary action] obvious.`
...
2. Chosen Light UI sub-direction.
...
- The first viewport clearly expresses Light UI.
...
Design a Light UI interface that feels open, clear, bright, lightweight, trustworthy, usable. Build a coherent system, not a skin: define layout, type, color, component geometry, imagery, motion, states, and responsive behavior. Use the reference database only to extract transferable rules, not to clone a source.

### Website Prompt

Create a complete Light UI website with navigation, a first viewport that states the product clearly, product or brand evidence, reusable sections, a clear conversion path, and a designed footer. The style must be visible in the first viewport and must remain usable on mobile.

### App Prompt

Create a Light UI app interface for repeated use. Prioritize the main workflow, control placement, information density, readable state design, and keyboard-accessible interactions. Preserve the style through surfaces, typography, spacing, and component behavior rather than decorative effects.

### Redesign Prompt

Redesign the existing interface in a Light UI direction. Preserve functionality and information architecture unless the user asks otherwise. Remove generic AI design patterns, assign tokens, improve hierarchy, define states, and make the first screen feel specific.

### Critique Prompt

Audit this design against Light UI. Identify generic defaults, weak hierarchy, misuse of color, bad typography, missing states, poor mobile behavior, and places where the style is decorative instead of structural.
