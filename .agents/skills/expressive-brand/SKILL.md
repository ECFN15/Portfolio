...
You are designing in the Expressive Brand style. The output must feel distinctive, memorable, colorful, confident, personality-led, specific. Do not merely apply a color theme; build a coherent visual system across layout, typography, color, component geometry, imagery, motion, and interaction states.

Use this skill when the user asks for brand-heavy sites, consumer products, creative launches, expressive agencies, campaigns, identity systems.
...
- Family - Expressive Brand Source Notes: 
- mymind - Expressive Brand Source Notes: 
- Antimetal - Expressive Brand Source Notes: 
- Empower - Expressive Brand Source Notes: 
- Retool - Expressive Brand Source Notes: 
...
| --- | --- | --- |
| Family - Expressive Brand Source Notes | Visual system reference | light expression, layout rhythm, component behavior |
| mymind - Expressive Brand Source Notes | Visual system reference | light expression, layout rhythm, component behavior |
| Antimetal - Expressive Brand Source Notes | Visual system reference | mixed expression, layout rhythm, component behavior |
| Empower - Expressive Brand Source Notes | Visual system reference | mixed expression, layout rhythm, component behavior |
| Retool - Expressive Brand Source Notes | Visual system reference | dark expression, layout rhythm, component behavior |
...
`This interface is a Expressive Brand system for [audience] that feels distinctive, memorable, colorful, confident, personality-led, specific and uses [layout move], [type move], [color move], and [component move] to make [primary action] obvious.`
...
2. Chosen Expressive Brand sub-direction.
...
- The first viewport clearly expresses Expressive Brand.
...
Design a Expressive Brand interface that feels distinctive, memorable, colorful, confident, personality-led, specific. Build a coherent system, not a skin: define layout, type, color, component geometry, imagery, motion, states, and responsive behavior. Use the reference database only to extract transferable rules, not to clone a source.

### Website Prompt

Create a complete Expressive Brand website with navigation, a first viewport that states the product clearly, product or brand evidence, reusable sections, a clear conversion path, and a designed footer. The style must be visible in the first viewport and must remain usable on mobile.

### App Prompt

Create a Expressive Brand app interface for repeated use. Prioritize the main workflow, control placement, information density, readable state design, and keyboard-accessible interactions. Preserve the style through surfaces, typography, spacing, and component behavior rather than decorative effects.

### Redesign Prompt

Redesign the existing interface in a Expressive Brand direction. Preserve functionality and information architecture unless the user asks otherwise. Remove generic AI design patterns, assign tokens, improve hierarchy, define states, and make the first screen feel specific.

### Critique Prompt

Audit this design against Expressive Brand. Identify generic defaults, weak hierarchy, misuse of color, bad typography, missing states, poor mobile behavior, and places where the style is decorative instead of structural.
