...
You are designing in the Editorial Minimal style. The output must feel quiet, typographic, spacious, authored, restrained, intentional. Do not merely apply a color theme; build a coherent visual system across layout, typography, color, component geometry, imagery, motion, and interaction states.

Use this skill when the user asks for minimal editorial pages, portfolios, cultural sites, calm brand systems, writing-heavy layouts, refined landing pages.
...
- Anthropic - Editorial Minimal Source Notes: 
- Legend - Editorial Minimal Source Notes: 
- Intercom - Editorial Minimal Source Notes: 
- Limitless - Editorial Minimal Source Notes: 
...
| --- | --- | --- |
| OpenAI - Editorial Minimal Source Notes | Visual system reference | light expression, layout rhythm, component behavior |
| Anthropic - Editorial Minimal Source Notes | Visual system reference | light expression, layout rhythm, component behavior |
| Legend - Editorial Minimal Source Notes | Visual system reference | light expression, layout rhythm, component behavior |
| Intercom - Editorial Minimal Source Notes | Visual system reference | light expression, layout rhythm, component behavior |
| Limitless - Editorial Minimal Source Notes | Visual system reference | light expression, layout rhythm, component behavior |
...
`This interface is a Editorial Minimal system for [audience] that feels quiet, typographic, spacious, authored, restrained, intentional and uses [layout move], [type move], [color move], and [component move] to make [primary action] obvious.`
...
2. Chosen Editorial Minimal sub-direction.
...
- The first viewport clearly expresses Editorial Minimal.
...
Design a Editorial Minimal interface that feels quiet, typographic, spacious, authored, restrained, intentional. Build a coherent system, not a skin: define layout, type, color, component geometry, imagery, motion, states, and responsive behavior. Use the reference database only to extract transferable rules, not to clone a source.

### Website Prompt

Create a complete Editorial Minimal website with navigation, a first viewport that states the product clearly, product or brand evidence, reusable sections, a clear conversion path, and a designed footer. The style must be visible in the first viewport and must remain usable on mobile.

### App Prompt

Create a Editorial Minimal app interface for repeated use. Prioritize the main workflow, control placement, information density, readable state design, and keyboard-accessible interactions. Preserve the style through surfaces, typography, spacing, and component behavior rather than decorative effects.

### Redesign Prompt

Redesign the existing interface in a Editorial Minimal direction. Preserve functionality and information architecture unless the user asks otherwise. Remove generic AI design patterns, assign tokens, improve hierarchy, define states, and make the first screen feel specific.

### Critique Prompt

Audit this design against Editorial Minimal. Identify generic defaults, weak hierarchy, misuse of color, bad typography, missing states, poor mobile behavior, and places where the style is decorative instead of structural.
