...
You are designing in the High-End Design style. The output must feel premium, restrained, confident, tactile, editorial, composed. Do not merely apply a color theme; build a coherent visual system across layout, typography, color, component geometry, imagery, motion, and interaction states.

Use this skill when the user asks for luxury sites, premium product pages, high-end portfolios, refined commerce, gallery-like brand systems.
...
- Bang & Olufsen - High-End Design Source Notes: https://styles.refero.design/style/27a4a4fa-4b1a-4e7e-b2c3-3e5bf57f00e5 (https://bang-olufsen.com)
- BMW.com - High-End Design Source Notes: https://styles.refero.design/style/b8899cbd-e2ca-4069-83cf-d8f8b0d71100 (https://bmw.com)
- Ferrari - High-End Design Source Notes: https://styles.refero.design/style/80164adf-a898-4f7c-bce7-12f3f62e1649 (https://ferrari.com)
- True Staging - High-End Design Source Notes: https://styles.refero.design/style/c26c462d-f219-4814-96da-c05e86f759b7 (https://www.truestaging.co.uk)
- Peak Design - High-End Design Source Notes: https://styles.refero.design/style/6f3fb64d-d4c9-4ec1-86a1-7983e5180985 (https://peakdesign.com)
...
| --- | --- | --- |
| Bang & Olufsen - High-End Design Source Notes | Gallery of precise objects. A dark, velvet-lined showcase where each product rests, spotlighted with refined exactitude. | mixed expression, layout rhythm, component behavior |
| BMW.com - High-End Design Source Notes | Precision-engineered monochrome luxury; every detail is intentional, nothing is superfluous. | light expression, layout rhythm, component behavior |
| Ferrari - High-End Design Source Notes | Precision engineered machinery. Like the interior of a sleek, high-performance engine, where every component is black or silver, and only critical indicators glow red. | mixed expression, layout rhythm, component behavior |
| True Staging - High-End Design Source Notes | Architectural blueprint on aged parchment | dark expression, layout rhythm, component behavior |
| Peak Design - High-End Design Source Notes | Photographic gallery on architectural black and white. Product precision through high-contrast typography. | light expression, layout rhythm, component behavior |
...
`This interface is a High-End Design system for [audience] that feels premium, restrained, confident, tactile, editorial, composed and uses [layout move], [type move], [color move], and [component move] to make [primary action] obvious.`
...
2. Chosen High-End Design sub-direction.
...
- The first viewport clearly expresses High-End Design.
...
Design a High-End Design interface that feels premium, restrained, confident, tactile, editorial, composed. Build a coherent system, not a skin: define layout, type, color, component geometry, imagery, motion, states, and responsive behavior. Use the reference database only to extract transferable rules, not to clone a source.

### Website Prompt

Create a complete High-End Design website with navigation, a first viewport that states the product clearly, product or brand evidence, reusable sections, a clear conversion path, and a designed footer. The style must be visible in the first viewport and must remain usable on mobile.

### App Prompt

Create a High-End Design app interface for repeated use. Prioritize the main workflow, control placement, information density, readable state design, and keyboard-accessible interactions. Preserve the style through surfaces, typography, spacing, and component behavior rather than decorative effects.

### Redesign Prompt

Redesign the existing interface in a High-End Design direction. Preserve functionality and information architecture unless the user asks otherwise. Remove generic AI design patterns, assign tokens, improve hierarchy, define states, and make the first screen feel specific.

### Critique Prompt

Audit this design against High-End Design. Identify generic defaults, weak hierarchy, misuse of color, bad typography, missing states, poor mobile behavior, and places where the style is decorative instead of structural.
