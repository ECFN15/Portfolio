...
You are designing in the High Contrast style. The output must feel direct, sharp, readable, confident, editorial, precise. Do not merely apply a color theme; build a coherent visual system across layout, typography, color, component geometry, imagery, motion, and interaction states.

Use this skill when the user asks for stark brand sites, editorial product pages, technical consoles, monochrome pages, bold launch pages.
...
- Colab - High Contrast Source Notes: https://styles.refero.design/style/b040360c-38de-4c5f-aada-bd3a67cbedc2 (https://colab.munken.com)
- Holographik - High Contrast Source Notes: https://styles.refero.design/style/f46616d6-5138-408b-a29d-b6749a6f3b04 (https://www.holographik.co)
- HARDCLO - High Contrast Source Notes: https://styles.refero.design/style/c3cf4acc-da7a-4496-8c4b-aa89a7c9e36c (https://hardclo.com)
- HyperAktiv - High Contrast Source Notes: https://styles.refero.design/style/d19c6fc3-1fc6-44a0-9c22-a0a82f7f79b4 (https://hyperaktiv.li)
- Hugging Face - High Contrast Source Notes: https://styles.refero.design/style/4363070d-02da-4954-88e4-d4a2101c5204 (https://huggingface.co)
...
| --- | --- | --- |
| Colab - High Contrast Source Notes | High-contrast theatrical canvas | dark expression, layout rhythm, component behavior |
| Holographik - High Contrast Source Notes | High-contrast monochrome blueprint | dark expression, layout rhythm, component behavior |
| HARDCLO - High Contrast Source Notes | Monochrome cinematic canvas - stark black and white drama | dark expression, layout rhythm, component behavior |
| HyperAktiv - High Contrast Source Notes | High-contrast stark blueprint | light expression, layout rhythm, component behavior |
| Hugging Face - High Contrast Source Notes | High-contrast data console, a brightly lit control panel with precise readouts and subtle depth | light expression, layout rhythm, component behavior |
...
`This interface is a High Contrast system for [audience] that feels direct, sharp, readable, confident, editorial, precise and uses [layout move], [type move], [color move], and [component move] to make [primary action] obvious.`
...
2. Chosen High Contrast sub-direction.
...
- The first viewport clearly expresses High Contrast.
...
Design a High Contrast interface that feels direct, sharp, readable, confident, editorial, precise. Build a coherent system, not a skin: define layout, type, color, component geometry, imagery, motion, states, and responsive behavior. Use the reference database only to extract transferable rules, not to clone a source.

### Website Prompt

Create a complete High Contrast website with navigation, a first viewport that states the product clearly, product or brand evidence, reusable sections, a clear conversion path, and a designed footer. The style must be visible in the first viewport and must remain usable on mobile.

### App Prompt

Create a High Contrast app interface for repeated use. Prioritize the main workflow, control placement, information density, readable state design, and keyboard-accessible interactions. Preserve the style through surfaces, typography, spacing, and component behavior rather than decorative effects.

### Redesign Prompt

Redesign the existing interface in a High Contrast direction. Preserve functionality and information architecture unless the user asks otherwise. Remove generic AI design patterns, assign tokens, improve hierarchy, define states, and make the first screen feel specific.

### Critique Prompt

Audit this design against High Contrast. Identify generic defaults, weak hierarchy, misuse of color, bad typography, missing states, poor mobile behavior, and places where the style is decorative instead of structural.
