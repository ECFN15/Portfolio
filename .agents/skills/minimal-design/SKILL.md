...
You are designing in the Minimal Design style. The output must feel essential, restrained, quiet, precise, spacious, intentional. Do not merely apply a color theme; build a coherent visual system across layout, typography, color, component geometry, imagery, motion, and interaction states.

Use this skill when the user asks for minimal websites, refined portfolios, product pages, calm brand systems, simple tools.
...
- General Intelligence Company - Minimal Design Source Notes: 
- Sprig - Minimal Design Source Notes: 
- Standards - Minimal Design Source Notes: 
- Rox - Minimal Design Source Notes: 
- Copy - Minimal Design Source Notes: 
...
| --- | --- | --- |
| General Intelligence Company - Minimal Design Source Notes | Visual system reference | mixed expression, layout rhythm, component behavior |
| Sprig - Minimal Design Source Notes | Visual system reference | light expression, layout rhythm, component behavior |
| Standards - Minimal Design Source Notes | Visual system reference | light expression, layout rhythm, component behavior |
| Rox - Minimal Design Source Notes | Visual system reference | light expression, layout rhythm, component behavior |
| Copy - Minimal Design Source Notes | Visual system reference | light expression, layout rhythm, component behavior |
...
`This interface is a Minimal Design system for [audience] that feels essential, restrained, quiet, precise, spacious, intentional and uses [layout move], [type move], [color move], and [component move] to make [primary action] obvious.`
...
2. Chosen Minimal Design sub-direction.
...
- The first viewport clearly expresses Minimal Design.
...
Design a Minimal Design interface that feels essential, restrained, quiet, precise, spacious, intentional. Build a coherent system, not a skin: define layout, type, color, component geometry, imagery, motion, states, and responsive behavior. Use the reference database only to extract transferable rules, not to clone a source.

### Website Prompt

Create a complete Minimal Design website with navigation, a first viewport that states the product clearly, product or brand evidence, reusable sections, a clear conversion path, and a designed footer. The style must be visible in the first viewport and must remain usable on mobile.

### App Prompt

Create a Minimal Design app interface for repeated use. Prioritize the main workflow, control placement, information density, readable state design, and keyboard-accessible interactions. Preserve the style through surfaces, typography, spacing, and component behavior rather than decorative effects.

### Redesign Prompt

Redesign the existing interface in a Minimal Design direction. Preserve functionality and information architecture unless the user asks otherwise. Remove generic AI design patterns, assign tokens, improve hierarchy, define states, and make the first screen feel specific.

### Critique Prompt

Audit this design against Minimal Design. Identify generic defaults, weak hierarchy, misuse of color, bad typography, missing states, poor mobile behavior, and places where the style is decorative instead of structural.
