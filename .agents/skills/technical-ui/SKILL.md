...
You are designing in the Technical UI style. The output must feel precise, operational, structured, intelligent, focused, trustworthy. Do not merely apply a color theme; build a coherent visual system across layout, typography, color, component geometry, imagery, motion, and interaction states.

Use this skill when the user asks for technical interfaces, product dashboards, AI tools, developer consoles, workflow apps, dense control surfaces.
...
- User Interviews — Technical UI Source Notes: https://styles.refero.design/style/376baf20-9ace-405d-bf4a-086016f2b1e3
- ChatGPT — Technical UI Source Notes: https://styles.refero.design/style/52a007ed-ad1b-46a6-bd44-b76f91df6d0c
- Attio — Technical UI Source Notes: https://styles.refero.design/style/08c8700c-f278-42bc-812e-f60dc6ce996e
- Telepathic Instruments — Technical UI Source Notes: https://styles.refero.design/style/5183054c-4c6e-4ecf-bd90-f7d794d5eb17
- ToDesktop — Technical UI Source Notes: https://styles.refero.design/style/dd89ce6c-f0aa-4ca8-bd63-19dcd81920a7
...
| --- | --- | --- |
| User Interviews — Technical UI Source Notes | Teal-accented architectural blueprint on pristine parchment. | light expression, layout rhythm, component behavior |
| ChatGPT — Technical UI Source Notes | Frosted glass workstation. | light expression, layout rhythm, component behavior |
| Attio — Technical UI Source Notes | Precision Digital Toolkit. | light expression, layout rhythm, component behavior |
| Telepathic Instruments — Technical UI Source Notes | Techno-futurist laboratory. | light expression, layout rhythm, component behavior |
| ToDesktop — Technical UI Source Notes | Digital engineering lab. | mixed expression, layout rhythm, component behavior |
...
`This interface is a Technical UI system for [audience] that feels precise, operational, structured, intelligent, focused, trustworthy and uses [layout move], [type move], [color move], and [component move] to make [primary action] obvious.`
...
2. Chosen Technical UI sub-direction.
...
- The first viewport clearly expresses Technical UI.
...
Design a Technical UI interface that feels precise, operational, structured, intelligent, focused, trustworthy. Build a coherent system, not a skin: define layout, type, color, component geometry, imagery, motion, states, and responsive behavior. Use the reference database only to extract transferable rules, not to clone a source.

### Website Prompt

Create a complete Technical UI website with navigation, a first viewport that states the product clearly, product or brand evidence, reusable sections, a clear conversion path, and a designed footer. The style must be visible in the first viewport and must remain usable on mobile.

### App Prompt

Create a Technical UI app interface for repeated use. Prioritize the main workflow, control placement, information density, readable state design, and keyboard-accessible interactions. Preserve the style through surfaces, typography, spacing, and component behavior rather than decorative effects.

### Redesign Prompt

Redesign the existing interface in a Technical UI direction. Preserve functionality and information architecture unless the user asks otherwise. Remove generic AI design patterns, assign tokens, improve hierarchy, define states, and make the first screen feel specific.

### Critique Prompt

Audit this design against Technical UI. Identify generic defaults, weak hierarchy, misuse of color, bad typography, missing states, poor mobile behavior, and places where the style is decorative instead of structural.
