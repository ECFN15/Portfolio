...
You are designing in the Monochrome UI style. The output must feel disciplined, stark, systematic, editorial, exact, reduced. Do not merely apply a color theme; build a coherent visual system across layout, typography, color, component geometry, imagery, motion, and interaction states.

Use this skill when the user asks for black-white-gray interfaces, monochrome dashboards, editorial systems, technical products, reduced visual identities.
...
- Figma Config - Monochrome UI Source Notes: https://styles.refero.design/style/8caa5004-a8cc-4c7e-a2bb-00ff60618729 (https://config.figma.com/events/figma-config-2022)
- mono - Monochrome UI Source Notes: https://styles.refero.design/style/859f6be7-9d2d-4da6-a9b7-baa658172696 (https://mono.frm.fm/en)
- Yung Studio - Monochrome UI Source Notes: https://styles.refero.design/style/2d43b251-ad01-4e59-9068-502457aa0592 (https://yung.studio)
- kaisermann - Monochrome UI Source Notes: https://styles.refero.design/style/872ce8b7-993d-4dea-a361-9ccb59d136c0 (https://kaisermann.me)
- Ui - Monochrome UI Source Notes: https://styles.refero.design/style/0fd67ec5-7e9c-4ca9-b368-5d9c7388477a (https://ui.shadcn.com)
...
| --- | --- | --- |
| Figma Config - Monochrome UI Source Notes | monochrome command console | dark expression, layout rhythm, component behavior |
| mono - Monochrome UI Source Notes | Architectural grid on white | light expression, layout rhythm, component behavior |
| Yung Studio - Monochrome UI Source Notes | Monochromatic Command Center. Pure black canvas where sharp white elements punctuate with precision and ample negative space. | dark expression, layout rhythm, component behavior |
| kaisermann - Monochrome UI Source Notes | monochrome command-line interface | dark expression, layout rhythm, component behavior |
| Ui - Monochrome UI Source Notes | Monochromatic architectural blueprint – precise, functional forms on a stark, bright canvas. | light expression, layout rhythm, component behavior |
...
`This interface is a Monochrome UI system for [audience] that feels disciplined, stark, systematic, editorial, exact, reduced and uses [layout move], [type move], [color move], and [component move] to make [primary action] obvious.`
...
2. Chosen Monochrome UI sub-direction.
...
- The first viewport clearly expresses Monochrome UI.
...
Design a Monochrome UI interface that feels disciplined, stark, systematic, editorial, exact, reduced. Build a coherent system, not a skin: define layout, type, color, component geometry, imagery, motion, states, and responsive behavior. Use the reference database only to extract transferable rules, not to clone a source.

### Website Prompt

Create a complete Monochrome UI website with navigation, a first viewport that states the product clearly, product or brand evidence, reusable sections, a clear conversion path, and a designed footer. The style must be visible in the first viewport and must remain usable on mobile.

### App Prompt

Create a Monochrome UI app interface for repeated use. Prioritize the main workflow, control placement, information density, readable state design, and keyboard-accessible interactions. Preserve the style through surfaces, typography, spacing, and component behavior rather than decorative effects.

### Redesign Prompt

Redesign the existing interface in a Monochrome UI direction. Preserve functionality and information architecture unless the user asks otherwise. Remove generic AI design patterns, assign tokens, improve hierarchy, define states, and make the first screen feel specific.

### Critique Prompt

Audit this design against Monochrome UI. Identify generic defaults, weak hierarchy, misuse of color, bad typography, missing states, poor mobile behavior, and places where the style is decorative instead of structural.
