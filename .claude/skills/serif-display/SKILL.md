...
You are designing in the Serif Display style. The output must feel editorial, elegant, literary, premium, expressive, composed. Do not merely apply a color theme; build a coherent visual system across layout, typography, color, component geometry, imagery, motion, and interaction states.

Use this skill when the user asks for serif-led brand sites, luxury, editorial pages, cultural projects, typographic portfolios, premium commerce.
...
| --- | --- | --- |
| Sociotype — Style Reference | Visual system reference | layout rhythm, component behavior, palette discipline |
| Fidèle Editions — Style Reference | Visual system reference | layout rhythm, component behavior, palette discipline |
| Pangram Pangram Foundry — Style Reference | Visual system reference | layout rhythm, component behavior, palette discipline |
| Standards — Style Reference | Visual system reference | layout rhythm, component behavior, palette discipline |
| UNVEIL® — Style Reference | Visual system reference | layout rhythm, component behavior, palette discipline |
...
`This interface is a Serif Display system for [audience] that feels editorial, elegant, literary, premium, expressive, composed and uses [layout move], [type move], [color move], and [component move] to make [primary action] obvious.`
...
2. Chosen Serif Display sub-direction.
...
- The first viewport clearly expresses Serif Display.
...
Design a Serif Display interface that feels editorial, elegant, literary, premium, expressive, composed. Build a coherent system, not a skin: define layout, type, color, component geometry, imagery, motion, states, and responsive behavior. Use the reference database only to extract transferable rules, not to clone a source.

### Website Prompt

Create a complete Serif Display website with navigation, a first viewport that states the product clearly, product or brand evidence, reusable sections, a clear conversion path, and a designed footer. The style must be visible in the first viewport and must remain usable on mobile.

### App Prompt

Create a Serif Display app interface for repeated use. Prioritize the main workflow, control placement, information density, readable state design, and keyboard-accessible interactions. Preserve the style through surfaces, typography, spacing, and component behavior rather than decorative effects.

### Redesign Prompt

Redesign the existing interface in a Serif Display direction. Preserve functionality and information architecture unless the user asks otherwise. Remove generic AI design patterns, assign tokens, improve hierarchy, define states, and make the first screen feel specific.

### Critique Prompt

Audit this design against Serif Display. Identify generic defaults, weak hierarchy, misuse of color, bad typography, missing states, poor mobile behavior, and places where the style is decorative instead of structural.
