...
You are designing in the Vibrant Accents style. The output must feel clean, energetic, vivid, modern, selective, confident. Do not merely apply a color theme; build a coherent visual system across layout, typography, color, component geometry, imagery, motion, and interaction states.

Use this skill when the user asks for brands needing restrained layouts with vivid highlights, SaaS, portfolios, consumer pages, launch sites.
...
- Stripe - Vibrant Accents Source Notes: 
- SquadEasy - Vibrant Accents Source Notes: 
- Base44 - Vibrant Accents Source Notes: 
- Empower - Vibrant Accents Source Notes: 
- Copy - Vibrant Accents Source Notes: 
...
| --- | --- | --- |
| Stripe - Vibrant Accents Source Notes | Visual system reference | light expression, layout rhythm, component behavior |
| SquadEasy - Vibrant Accents Source Notes | Visual system reference | light expression, layout rhythm, component behavior |
| Base44 - Vibrant Accents Source Notes | Visual system reference | light expression, layout rhythm, component behavior |
| Empower - Vibrant Accents Source Notes | Visual system reference | mixed expression, layout rhythm, component behavior |
| Copy - Vibrant Accents Source Notes | Visual system reference | light expression, layout rhythm, component behavior |
...
`This interface is a Vibrant Accents system for [audience] that feels clean, energetic, vivid, modern, selective, confident and uses [layout move], [type move], [color move], and [component move] to make [primary action] obvious.`
...
2. Chosen Vibrant Accents sub-direction.
...
- The first viewport clearly expresses Vibrant Accents.
...
Design a Vibrant Accents interface that feels clean, energetic, vivid, modern, selective, confident. Build a coherent system, not a skin: define layout, type, color, component geometry, imagery, motion, states, and responsive behavior. Use the reference database only to extract transferable rules, not to clone a source.

### Website Prompt

Create a complete Vibrant Accents website with navigation, a first viewport that states the product clearly, product or brand evidence, reusable sections, a clear conversion path, and a designed footer. The style must be visible in the first viewport and must remain usable on mobile.

### App Prompt

Create a Vibrant Accents app interface for repeated use. Prioritize the main workflow, control placement, information density, readable state design, and keyboard-accessible interactions. Preserve the style through surfaces, typography, spacing, and component behavior rather than decorative effects.

### Redesign Prompt

Redesign the existing interface in a Vibrant Accents direction. Preserve functionality and information architecture unless the user asks otherwise. Remove generic AI design patterns, assign tokens, improve hierarchy, define states, and make the first screen feel specific.

### Critique Prompt

Audit this design against Vibrant Accents. Identify generic defaults, weak hierarchy, misuse of color, bad typography, missing states, poor mobile behavior, and places where the style is decorative instead of structural.
