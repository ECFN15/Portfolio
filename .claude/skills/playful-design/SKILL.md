...
You are designing in the Playful Design style. The output must feel joyful, tactile, friendly, colorful, energetic, approachable. Do not merely apply a color theme; build a coherent visual system across layout, typography, color, component geometry, imagery, motion, and interaction states.

Use this skill when the user asks for playful brands, education, consumer apps, creative tools, family products, gamified experiences, friendly SaaS.
...
- Playful — Playful Design Source Notes: https://styles.refero.design/style/f93ac72e-73b2-4b2c-80eb-351ddfa56f4d
- Maxima Therapy — Playful Design Source Notes: https://styles.refero.design/style/a122b132-2259-41ca-a301-4468dd17a386
- Playdate — Playful Design Source Notes: https://styles.refero.design/style/2175034b-96d7-417e-886f-ff5a4d8551ae
- Duolingo — Playful Design Source Notes: https://styles.refero.design/style/7088d695-362b-4e09-b325-fa8136d4f350
- Clay — Playful Design Source Notes: https://styles.refero.design/style/b5ca4e9a-2322-4796-b4c5-3b3bf194821f
...
| --- | --- | --- |
| Playful — Playful Design Source Notes | Gradient Playground. | light expression, layout rhythm, component behavior |
| Maxima Therapy — Playful Design Source Notes | Vibrant, rounded play-world. | light expression, layout rhythm, component behavior |
| Playdate — Playful Design Source Notes | Lemon Drop Arcade. | mixed expression, layout rhythm, component behavior |
| Duolingo — Playful Design Source Notes | Playground Starter Kit. | light expression, layout rhythm, component behavior |
| Clay — Playful Design Source Notes | Playful Precision Playground. | light expression, layout rhythm, component behavior |
...
`This interface is a Playful Design system for [audience] that feels joyful, tactile, friendly, colorful, energetic, approachable and uses [layout move], [type move], [color move], and [component move] to make [primary action] obvious.`
...
2. Chosen Playful Design sub-direction.
...
- The first viewport clearly expresses Playful Design.
...
Design a Playful Design interface that feels joyful, tactile, friendly, colorful, energetic, approachable. Build a coherent system, not a skin: define layout, type, color, component geometry, imagery, motion, states, and responsive behavior. Use the reference database only to extract transferable rules, not to clone a source.

### Website Prompt

Create a complete Playful Design website with navigation, a first viewport that states the product clearly, product or brand evidence, reusable sections, a clear conversion path, and a designed footer. The style must be visible in the first viewport and must remain usable on mobile.

### App Prompt

Create a Playful Design app interface for repeated use. Prioritize the main workflow, control placement, information density, readable state design, and keyboard-accessible interactions. Preserve the style through surfaces, typography, spacing, and component behavior rather than decorative effects.

### Redesign Prompt

Redesign the existing interface in a Playful Design direction. Preserve functionality and information architecture unless the user asks otherwise. Remove generic AI design patterns, assign tokens, improve hierarchy, define states, and make the first screen feel specific.

### Critique Prompt

Audit this design against Playful Design. Identify generic defaults, weak hierarchy, misuse of color, bad typography, missing states, poor mobile behavior, and places where the style is decorative instead of structural.
