...
You are designing in the Editorial Type style. The output must feel literary, expressive, composed, sharp, cultural, typographic. Do not merely apply a color theme; build a coherent visual system across layout, typography, color, component geometry, imagery, motion, and interaction states.

Use this skill when the user asks for typographic websites, magazine-like pages, cultural brands, essays, archives, portfolios, editorial commerce.
...
- Volume - Editorial Type Source Notes: https://styles.refero.design/style/edc0c03e-8c20-4e22-badd-2735fcb9f4a8 (https://vol.co)
- Victor Cango - Editorial Type Source Notes: https://styles.refero.design/style/66fdf7a4-7d28-452e-88ec-c84e49b3ae6f (https://victorcango.fr)
- No Ideas - Editorial Type Source Notes: https://styles.refero.design/style/908017b4-311c-4b89-afa5-c29c8cb08e8b (https://noideas.website)
- Sociotype - Editorial Type Source Notes: https://styles.refero.design/style/973332dc-4e10-4e90-85d8-3bce9c3cd3ed (https://socio-type.com)
- Christopherdoyle - Editorial Type Source Notes: https://styles.refero.design/style/e1223d32-c423-4c95-ae0a-8a6f8585e6a2 (https://christopherdoyle.co)
...
| --- | --- | --- |
| Volume - Editorial Type Source Notes | Editorial archive, high contrast. | light expression, layout rhythm, component behavior |
| Victor Cango - Editorial Type Source Notes | Editorial type on stark canvas | light expression, layout rhythm, component behavior |
| No Ideas - Editorial Type Source Notes | High-contrast editorial publication | dark expression, layout rhythm, component behavior |
| Sociotype - Editorial Type Source Notes | Editorial White Canvas | light expression, layout rhythm, component behavior |
| Christopherdoyle - Editorial Type Source Notes | Editorial Grid, Ink on Paper | light expression, layout rhythm, component behavior |
...
`This interface is a Editorial Type system for [audience] that feels literary, expressive, composed, sharp, cultural, typographic and uses [layout move], [type move], [color move], and [component move] to make [primary action] obvious.`
...
2. Chosen Editorial Type sub-direction.
...
- The first viewport clearly expresses Editorial Type.
...
Design a Editorial Type interface that feels literary, expressive, composed, sharp, cultural, typographic. Build a coherent system, not a skin: define layout, type, color, component geometry, imagery, motion, states, and responsive behavior. Use the reference database only to extract transferable rules, not to clone a source.

### Website Prompt

Create a complete Editorial Type website with navigation, a first viewport that states the product clearly, product or brand evidence, reusable sections, a clear conversion path, and a designed footer. The style must be visible in the first viewport and must remain usable on mobile.

### App Prompt

Create a Editorial Type app interface for repeated use. Prioritize the main workflow, control placement, information density, readable state design, and keyboard-accessible interactions. Preserve the style through surfaces, typography, spacing, and component behavior rather than decorative effects.

### Redesign Prompt

Redesign the existing interface in a Editorial Type direction. Preserve functionality and information architecture unless the user asks otherwise. Remove generic AI design patterns, assign tokens, improve hierarchy, define states, and make the first screen feel specific.

### Critique Prompt

Audit this design against Editorial Type. Identify generic defaults, weak hierarchy, misuse of color, bad typography, missing states, poor mobile behavior, and places where the style is decorative instead of structural.
