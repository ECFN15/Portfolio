...
You are designing in the Geometric Modern style. The output must feel structured, contemporary, rational, bold, rhythmic, architectural. Do not merely apply a color theme; build a coherent visual system across layout, typography, color, component geometry, imagery, motion, and interaction states.

Use this skill when the user asks for geometric brand systems, modern portfolios, architecture, design districts, shape-led SaaS, structured editorial pages.
...
- Greenspace - Geometric Modern Source Notes: https://styles.refero.design/style/d961e174-875b-46ef-ad27-fe7f8e3bcd8c (https://thegreenspace.com)
- Artem Militonian - Geometric Modern Source Notes: https://styles.refero.design/style/c1749391-de9f-4500-a838-01d08a72fc00 (https://artmilitonian.com)
- V–A–C - Geometric Modern Source Notes: https://styles.refero.design/style/40154dc4-e681-4df9-be01-a6681d5887a6 (https://v-a-c.org/en)
- Theodore Ellison Designs - Geometric Modern Source Notes: https://styles.refero.design/style/f6bcbb63-2925-4bee-a330-e5e770b94750 (https://theodoreellison.com)
- Eindhoven Design District - Geometric Modern Source Notes: https://styles.refero.design/style/c90b584e-de5b-4971-9e13-8ab991bd96c0 (https://www.eindhovendesigndistrict.com)
...
| --- | --- | --- |
| Greenspace - Geometric Modern Source Notes | Monumental monochrome canvas | dark expression, layout rhythm, component behavior |
| Artem Militonian - Geometric Modern Source Notes | Monochrome Grid Blueprint | light expression, layout rhythm, component behavior |
| V–A–C - Geometric Modern Source Notes | Architectural grid on white | light expression, layout rhythm, component behavior |
| Theodore Ellison Designs - Geometric Modern Source Notes | Warm earth-tones, artisan typography | light expression, layout rhythm, component behavior |
| Eindhoven Design District - Geometric Modern Source Notes | Graphic Modernist Poster | light expression, layout rhythm, component behavior |
...
`This interface is a Geometric Modern system for [audience] that feels structured, contemporary, rational, bold, rhythmic, architectural and uses [layout move], [type move], [color move], and [component move] to make [primary action] obvious.`
...
2. Chosen Geometric Modern sub-direction.
...
- The first viewport clearly expresses Geometric Modern.
...
Design a Geometric Modern interface that feels structured, contemporary, rational, bold, rhythmic, architectural. Build a coherent system, not a skin: define layout, type, color, component geometry, imagery, motion, states, and responsive behavior. Use the reference database only to extract transferable rules, not to clone a source.

### Website Prompt

Create a complete Geometric Modern website with navigation, a first viewport that states the product clearly, product or brand evidence, reusable sections, a clear conversion path, and a designed footer. The style must be visible in the first viewport and must remain usable on mobile.

### App Prompt

Create a Geometric Modern app interface for repeated use. Prioritize the main workflow, control placement, information density, readable state design, and keyboard-accessible interactions. Preserve the style through surfaces, typography, spacing, and component behavior rather than decorative effects.

### Redesign Prompt

Redesign the existing interface in a Geometric Modern direction. Preserve functionality and information architecture unless the user asks otherwise. Remove generic AI design patterns, assign tokens, improve hierarchy, define states, and make the first screen feel specific.

### Critique Prompt

Audit this design against Geometric Modern. Identify generic defaults, weak hierarchy, misuse of color, bad typography, missing states, poor mobile behavior, and places where the style is decorative instead of structural.
