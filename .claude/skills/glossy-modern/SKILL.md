...
You are designing in the Glossy Modern style. The output must feel polished, luminous, smooth, premium, dimensional, modern. Do not merely apply a color theme; build a coherent visual system across layout, typography, color, component geometry, imagery, motion, and interaction states.

Use this skill when the user asks for polished modern SaaS, glassy product pages, premium tech, visual tools, interactive brand systems.
...
- Changelog - Glossy Modern Source Notes: 
- Raycast - Glossy Modern Source Notes: 
- Dia Browser - Glossy Modern Source Notes: 
- Ayo / Lava - Glossy Modern Source Notes: 
- monopo saigon - Glossy Modern Source Notes: 
...
| --- | --- | --- |
| Changelog - Glossy Modern Source Notes | Visual system reference | dark expression, layout rhythm, component behavior |
| Raycast - Glossy Modern Source Notes | Visual system reference | dark expression, layout rhythm, component behavior |
| Dia Browser - Glossy Modern Source Notes | Visual system reference | light expression, layout rhythm, component behavior |
| Ayo / Lava - Glossy Modern Source Notes | Visual system reference | dark expression, layout rhythm, component behavior |
| monopo saigon - Glossy Modern Source Notes | Visual system reference | dark expression, layout rhythm, component behavior |
...
`This interface is a Glossy Modern system for [audience] that feels polished, luminous, smooth, premium, dimensional, modern and uses [layout move], [type move], [color move], and [component move] to make [primary action] obvious.`
...
2. Chosen Glossy Modern sub-direction.
...
- The first viewport clearly expresses Glossy Modern.
...
Design a Glossy Modern interface that feels polished, luminous, smooth, premium, dimensional, modern. Build a coherent system, not a skin: define layout, type, color, component geometry, imagery, motion, states, and responsive behavior. Use the reference database only to extract transferable rules, not to clone a source.

### Website Prompt

Create a complete Glossy Modern website with navigation, a first viewport that states the product clearly, product or brand evidence, reusable sections, a clear conversion path, and a designed footer. The style must be visible in the first viewport and must remain usable on mobile.

### App Prompt

Create a Glossy Modern app interface for repeated use. Prioritize the main workflow, control placement, information density, readable state design, and keyboard-accessible interactions. Preserve the style through surfaces, typography, spacing, and component behavior rather than decorative effects.

### Redesign Prompt

Redesign the existing interface in a Glossy Modern direction. Preserve functionality and information architecture unless the user asks otherwise. Remove generic AI design patterns, assign tokens, improve hierarchy, define states, and make the first screen feel specific.

### Critique Prompt

Audit this design against Glossy Modern. Identify generic defaults, weak hierarchy, misuse of color, bad typography, missing states, poor mobile behavior, and places where the style is decorative instead of structural.
