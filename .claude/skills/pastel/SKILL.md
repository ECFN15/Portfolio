...
You are designing in the Pastel style. The output must feel soft, approachable, friendly, warm, optimistic, gentle. Do not merely apply a color theme; build a coherent visual system across layout, typography, color, component geometry, imagery, motion, and interaction states.

Use this skill when the user asks for soft consumer brands, wellness, friendly SaaS, playful products, approachable commerce, community pages.
...
| --- | --- | --- |
| Pastel — Style Reference | Visual system reference | layout rhythm, component behavior, palette discipline |
| Palette Supply — Style Reference | Visual system reference | layout rhythm, component behavior, palette discipline |
| Recess — Style Reference | Visual system reference | layout rhythm, component behavior, palette discipline |
| GRAZA — Style Reference | Visual system reference | layout rhythm, component behavior, palette discipline |
| Podcorn — Style Reference | Visual system reference | layout rhythm, component behavior, palette discipline |
| Podia — Style Reference | Visual system reference | layout rhythm, component behavior, palette discipline |
...
`This interface is a Pastel system for [audience] that feels soft, approachable, friendly, warm, optimistic, gentle and uses [layout move], [type move], [color move], and [component move] to make [primary action] obvious.`
...
- The first viewport clearly expresses Pastel.
...
Design a Pastel interface that feels soft, approachable, friendly, warm, optimistic, gentle. Build a coherent system, not a skin: define layout, type, color, component geometry, imagery, motion, states, and responsive behavior. Use the reference database only to extract transferable rules, not to clone a source.

### Website Prompt

Create a complete Pastel website with navigation, a first viewport that states the product clearly, product or brand evidence, reusable sections, a clear conversion path, and a designed footer. The style must be visible in the first viewport and must remain usable on mobile.

### App Prompt

Create a Pastel app interface for repeated use. Prioritize the main workflow, control placement, information density, readable state design, and keyboard-accessible interactions. Preserve the style through surfaces, typography, spacing, and component behavior rather than decorative effects.

### Redesign Prompt

Redesign the existing interface in a Pastel direction. Preserve functionality and information architecture unless the user asks otherwise. Remove generic AI design patterns, assign tokens, improve hierarchy, define states, and make the first screen feel specific.

### Critique Prompt

Audit this design against Pastel. Identify generic defaults, weak hierarchy, misuse of color, bad typography, missing states, poor mobile behavior, and places where the style is decorative instead of structural.
